 ...
 */
#define Url_Date_CreateItem @"http://www.talk2vc.com/api/v1/investor/process/founder/project"
 ...
 */
#define Url_Date_InvestorAccept @"http://www.talk2vc.com/api/v1/investor/process/investor/accept"

/**
 *  优惠码
 *  http://localhost:8084/chxp-apnt/api/v1/investor/validdiscountcode?code=sssz&orderId=7
 */
#define Url_Date_salesCode @"http://www.talk2vc.com/api/v1/investor/validdiscountcode"

/**
 *  投资人确认见过面 status为4
 *  http://localhost:8084/chxp-apnt/api/v1/investor/process/investor/makesure?type=1&orderId=7
 */
#define Url_Date_InvestorSureMeet @"http://www.talk2vc.com/api/v1/investor/process/investor/makesure"

/**
 *  创业者评价约谈stauts 为5
 *  http://localhost:8084/chxp-apnt/api/v1/investor/process/founder/evaluate?star=4&content=还行&orderId=7
 */
#define Url_Date_CreateCommentDate @"http://www.talk2vc.com/api/v1/investor/process/founder/evaluate"

/**
 *  创业者\投资人，订单信息，通过token区分
 *  ttp://localhost:8084/chxp-apnt/api/v1/investor/process/info?orderId=3
 */
#define Url_Date_CreateOrder @"http://www.talk2vc.com/api/v1/investor/process/info"
 ...
 */
#define Url_Date_list @"http://www.talk2vc.com/api/v1/investor/process/investor/projects"

/**
 *  确认预约投资人订单是否全部完成的接口（是否可以预约）
 *  http://localhost:8084/chxp-apnt/api/v1/investor/makesure/clickable?userId=176724
 */
#define Url_Date_OrderIsFinish @"http://www.talk2vc.com/api/v1/investor/makesure/clickable"
