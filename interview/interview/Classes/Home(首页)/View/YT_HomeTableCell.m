...
-(void)creatCollectionView
{
    ...
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(85, 38, ScreenWidth - 90, 75) collectionViewLayout:layout];
...
//    [self createItemTagCollectionView];
//    self.industryList = [NSMutableArray arrayWithArray:model.industryList];
}
