...
@interface YT_investorDate23Controller ()
...
@implementation YT_investorDate23Controller
...
- (void)createUI
{
    ...
    //背景白色view
    UIView *bgWhiteView = [[UIView alloc] initWithFrame:CGRectMake(10, 240, ScreenWidth - 20, 500)];
