...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(push) name:ReceiveRemoteNotification object:nil];
}

- (void)push
{
    YT_AboutApp *Vc = [[YT_AboutApp alloc] init];
...
- (void)dealloc
{
    ...
    //receiveNotification
    [[NSNotificationCenter defaultCenter] removeObserver:self name:ReceiveRemoteNotification object:nil];
}
